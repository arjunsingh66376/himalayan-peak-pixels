...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 text-center text-white pb-24">
        <div className="max-w-4xl mx-auto animate-fade-in-up">
          ...
          <p className="text-xl md:text-2xl mb-8 text-white/90 leading-relaxed">
            Discover premium herbs, organic honey, and other wild forest treasures sourced sustainably
            from the pristine Uttarakhand mountains.
          </p>
